...
let g:airline#themes#guzo#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#guzo#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#guzo#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)

" Inactive mode
let s:IN1 = [ '#9e9e9e' , '#303030' , 247 , 236 ]
let s:IN2 = [ '#ffffff' , '#121212' , 15  , 240 ]

let s:IA = [ s:IN1[1] , s:IN2[1] , s:IN1[3] , s:IN2[3] , '' ]
let g:airline#themes#guzo#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
